...
namespace Warshti.Panel.Areas.Car.Controllers
{
    ...
    public class ModelController : Controller
    {
        ...
        public IActionResult LoadData()
        {
            ...
            var tempData = _context.Models.AsQueryable();
        ...
        {
            var model = new ModelCreateViewModel()
            {
            };
        ...
        {
            var temp = _context.Models.FirstOrDefault(p => p.Id == id);
            if (temp == null)
            {
                return NotFound();
            }

            var model = new ModelUpdateViewModel()
            {
                Id = temp.Id,
                Name = temp.Name
            };
        ...
        public async Task<IActionResult> Update(ModelUpdateViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                var temp = _context.Models.FirstOrDefault(p => p.Id == model.Id);
                if (temp == null)
                {
                    return NotFound();
                }
