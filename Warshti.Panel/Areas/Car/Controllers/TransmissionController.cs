...
namespace Warshti.Panel.Areas.Car.Controllers
{
    ...
    public class TransmissionController : Controller
    {
        ...
        public IActionResult LoadData()
        {
            ...
            var tempData = _context.Transmissions.AsQueryable();
        ...
        {
            var model = new TransmissionCreateViewModel()
            {
            };
        ...
        public async Task<IActionResult> Create(TransmissionCreateViewModel model)
        {
        ...
        {
            var temp = _context.Transmissions.FirstOrDefault(p => p.Id == id);
            if (temp == null)
            {
                return NotFound();
            }

            var model = new TransmissionUpdateViewModel()
            {
                Id = temp.Id,
                Name = temp.Name
            };
        ...
        [HttpPost()]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Update(TransmissionUpdateViewModel model)
        {

            if (ModelState.IsValid)
            {
                var temp = _context.Transmissions.FirstOrDefault(p => p.Id == model.Id);
                if (temp == null)
                {
                    return NotFound();
                }
