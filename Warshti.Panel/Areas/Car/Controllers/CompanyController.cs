...
namespace Warshti.Panel.Areas.Car.Controllers
{
    ...
    public class CompanyController : Controller
    {
        ...
        public IActionResult LoadData()
        {
            ...
            var tempData = _context.Companies.AsQueryable();
        ...
        {
            var temp = _context.Companies.FirstOrDefault(p => p.Id == id);
            if (temp == null)
            {
                return NotFound();
            }
        ...
        [HttpPost()]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Update(CompanyUpdateViewModel model)
        {

            if (ModelState.IsValid)
            {
                var temp = _context.Companies.FirstOrDefault(p => p.Id == model.Id);
                if (temp == null)
                {
                    return NotFound();
                }
