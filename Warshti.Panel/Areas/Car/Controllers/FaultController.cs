...
namespace Warshti.Panel.Areas.Car.Controllers
{
    ...
    public class FaultController : Controller
    {
        ...
        public IActionResult LoadData()
        {
            ...
            var tempData = _context.Faults.AsQueryable();
        ...
        {
            var model = new FaultCreateViewModel()
            {
            };
        ...
        public async Task<IActionResult> Create(FaultCreateViewModel model)
        {
        ...
        {
            var temp = _context.Faults.FirstOrDefault(p => p.Id == id);
            if (temp == null)
            {
                return NotFound();
            }

            var model = new FaultUpdateViewModel()
            {
                Id = temp.Id,
                Name = temp.Name
            };
        ...
        [HttpPost()]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Update(FaultUpdateViewModel model)
        {

            if (ModelState.IsValid)
            {
                var temp = _context.Faults.FirstOrDefault(p => p.Id == model.Id);
                if (temp == null)
                {
                    return NotFound();
                }
