...
namespace Warshti.Panel.Areas.Lookup.Controllers
{
    ...
    public class DepartmentController : Controller
    {
        ...
        public IActionResult LoadData()
        {
            ...
            var tempData = _context.Departments.AsQueryable();
        ...
        {
            var temp = _context.Departments.FirstOrDefault(p => p.Id == id);
            if (temp == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Update(DepartmentUpdateViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                var temp = _context.Departments.FirstOrDefault(p => p.Id == model.Id);
                if (temp == null)
                {
                    return NotFound();
                }
