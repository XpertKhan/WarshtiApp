...
namespace Warshti.Panel.Areas.Lookup.Controllers
{
    ...
    public class LanguageController : Controller
    {
        ...
        public IActionResult LoadData()
        {
            ...
            var tempData = _context.Languages.AsQueryable();
        ...
        {
            var temp = _context.Languages.FirstOrDefault(p => p.Id == id);
            if (temp == null)
            {
                return NotFound();
            }

            var model = new LanguageUpdateViewModel()
            {
                Id = temp.Id,
                Name = temp.Name
            };
        ...
        public async Task<IActionResult> Update(LanguageUpdateViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                var temp = _context.Languages.FirstOrDefault(p => p.Id == model.Id);
                if (temp == null)
                {
                    return NotFound();
                }
